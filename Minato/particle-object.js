/* ═══════════════════════════════════════════════════════════
   ...
   Vanilla-JS port of the React component (canvasui/ParticleObject).
   Same options, same simulation; the React wrapper is dropped and
   createParticleObject({ canvas }, options) is the whole API.
   ═══════════════════════════════════════════════════════════ */
...
export function createParticleObject(elements, options = {}) {
  ...
  function applyOptions() {
    ...
    canvas.style.touchAction = config.orbit || config.zoom ? 'none' : 'auto';
...
export default createParticleObject;
